...
Original file is located at
    https://colab.research.google.com/drive/1DUgqHYElbDs3NUPXaI5iF0_7Gp2yvhCx
...
!gdown --id '1HlQRkY_TMXi_Q2w1_AUrOnKqtyRJKzUU' --output data-bin.tar.gz
    ...
    def __init__(self):
        ...
        self.encoder = nn.Sequential(
            ...
            nn.BatchNorm2d(24, momentum = 0.01),
			      # nn.Conv2d(24, 96, 4, stride=2, padding=1),
        ...
        self.decoder = nn.Sequential(
            ...
            # nn.ReLU(),
			      # nn.ConvTranspose2d(96, 24, 4, stride=2, padding=1), 
            # nn.BatchNorm2d(24, momentum = 0.01),
            # nn.ReLU(),
...
class Resnet(nn.Module):
    def __init__(self, fc_hidden1=1024, fc_hidden2=768, drop_p=0.3, CNN_embed_dim=256):
        ...
        self.fc5 = nn.Linear(self.fc_hidden2, 128 * 4 * 4)
        ...
        self.convTrans7 = nn.Sequential(
            nn.ConvTranspose2d(in_channels=64, out_channels=8, kernel_size=self.k3, stride=self.s3,
                               padding=self.pd3),
    ...
    def decode(self, z):
        if z.shape[0] > 1:
            ...
            x = self.relu(self.fc5(x)).view(-1, 128, 4, 4)
        x = self.convTrans6(x)
        x = self.convTrans7(x)
        x = self.convTrans8(x)
...
num_epochs = 256
batch_size = 1024 # medium: smaller batchsize
learning_rate = 1e-3
