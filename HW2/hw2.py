...
!gdown --id '1k071e8qOFVhkMhPXQy_c_tJaX47ER_m-' --output data.zip
!unzip data.zip
!ls
...
class Classifier(nn.Module):
    def __init__(self):
        ...
        self.layer1 = nn.Linear(2816, 512)
        ...
        self.conv1 = nn.Conv1d(39, 64, 3, stride = 1, padding = 1)
        self.conv2 = nn.Conv1d(64, 128, 3, stride = 1, padding = 1)
        self.conv3 = nn.Conv1d(128, 256, 3, stride = 1, padding = 1)

        self.mp1 = nn.MaxPool1d(2, stride = 1)
        self.mp2 = nn.MaxPool1d(2, stride = 1)
        self.mp3 = nn.MaxPool1d(2, stride = 1)

        self.bn1 = nn.BatchNorm1d(64)
        self.bn2 = nn.BatchNorm1d(128)
        self.bn3 = nn.BatchNorm1d(256)

        self.bno = nn.BatchNorm1d(39)
